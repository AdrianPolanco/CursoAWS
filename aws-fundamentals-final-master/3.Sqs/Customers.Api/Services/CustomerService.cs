...
public class CustomerService : ICustomerService
{
    ...
    public async Task<bool> CreateAsync(Customer customer)
    {
        ...
        if (response) await _sqsMessenger.SendMessageAsync(customer.ToCustomerCreatedMessage(), new CancellationToken());
    ...
    public async Task<bool> UpdateAsync(Customer customer)
    {
        ...
        if (response) await _sqsMessenger.SendMessageAsync(customer.ToCustomerUpdatedMessage(), new CancellationToken());
        return response;
    }
    ...
    public async Task<bool> DeleteAsync(Guid id)
    {
        ...
        if(response) await _sqsMessenger.SendMessageAsync(new CustomerDeleted { Id = id }, cancellationToken: new());
